...
export class CalendarsPageComponent implements OnInit, OnDestroy {
  ...
  get displayedColumns(): string[] {
    if (this.all) {
      return ['archived', 'location', 'name', 'span', 'cluster_len', 'day_begin', 'day_len', 'day_offset', 'week_days', 'actions'];
    } else {
      return ['location', 'name', 'span',  'cluster_len', 'day_begin', 'day_len', 'day_offset', 'week_days', 'actions'];
    }
  }
